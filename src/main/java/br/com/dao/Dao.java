...
public abstract class Dao<T extends Usuario, K> implements Serializable {
    ...
    public boolean addEvento(Evento evento, String emailUsuario) {
        return get(emailUsuario).addEvento(evento) && saveInFile();
    }

    public boolean removerEvento(Evento evento, String emailUsuario) {
        return get(emailUsuario).removeEvento(evento) && saveInFile();
    }
