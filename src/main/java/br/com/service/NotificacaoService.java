...
public class NotificacaoService {
    ...
    public List<Notificacao> getNotContratante(@PathParam("email") String email) {
        return repository.daoNotificacao.getAll().stream().filter(o -> repository.daoPropostas.get(o.getIdProposta()).getEmailContratante().equals(email)).collect(Collectors.toList());
    }
    ...
    public List<Notificacao> getNotArtista(@PathParam("email") String email) {
        return repository.daoNotificacao.getAll().stream().filter(o -> repository.daoPropostas.get(o.getIdProposta()).getEmailArtista().equals(email)).collect(Collectors.toList());
    }
    ...
    public List<Notificacao> getNotEvento(@PathParam("id") int id) {
        return repository.daoNotificacao.getAll().stream().filter(o -> repository.daoPropostas.get(o.getIdProposta()).getIdEvento() == id).collect(Collectors.toList());
    }
    ...
    public boolean add(Notificacao notificacao) {
        Notificacao not = new Notificacao(notificacao.getIdProposta());
