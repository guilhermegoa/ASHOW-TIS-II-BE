...
public class DaoEventos implements Serializable {
    ...
    public boolean update(int id, Evento evento) {
        ...
        if (x.anyMatch(o -> o.getNome().equals(evento.getNome()))) {
            ...
            if (evento.getValor() != contratante.getValor())
                contratante.setValor(evento.getValor());
            if (evento.getEstilo() != null)
                contratante.setEstilo(evento.getEstilo());
            if (evento.getNome() != null)
                contratante.setNome(evento.getNome());
            if (evento.isOpen() != contratante.isOpen())
                contratante.setOpen(evento.isOpen());
            if (evento.getData() != null)
                contratante.setData(evento.getData());
            if (evento.getEndereco() != null)
                contratante.setEndereco(evento.getEndereco());
    ...
    public boolean add(Evento evento) {
        ...
        else if (dados.add((Evento) evento)) return saveInFile();
        else return false;
    }
