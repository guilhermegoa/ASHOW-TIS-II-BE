...
public class EventoService {
    ...
    public Evento get(@PathParam("id") int id) {
        return Sistema.getRepository().daoEventos != null ? Sistema.getRepository().daoEventos.get(id) : null;
    }
    ...
    public boolean remove(@PathParam("id") int id) {
        ...
        List<Evento> eventos = Sistema.getRepository().daoEventos.getAll().stream().filter(a -> a.getId() == (id))
