...
public class ContratanteService {
    ...
    public boolean remove(@PathParam("email") String email) {
        ...
        List<Usuario> contratantes = Sistema.getRepository().daoUsuarios.getAll().stream().filter(a -> a.getEmail().equals(email)).filter(a -> a instanceof Contratante).collect(Collectors.toList());
