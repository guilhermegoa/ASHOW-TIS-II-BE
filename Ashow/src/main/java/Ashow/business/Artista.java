...
import Ashow.interfac.JsonFormatter;

public class Artista extends Usuario implements Serializable, JsonFormatter {
	...
	public JSONObject toJson() {
    	...
    	obj.put("nomeArtistico", this.getNomeArtistico());
    	obj.put("estilo", this.getEstilo());
    	obj.put("contato", this.getContatoPublico());
    	obj.put("popularidade", this.getPopularidade());
    	obj.put("descricao", this.getDescricao());
    	obj.put("numeroEventos", this.getNumeroEventos());
		return obj;
	}
